...
namespace InsuranceQuoteApp.Controllers
{
    public class InsuranceController : Controller
    {
        ...
        [HttpPost]
        public IActionResult CalculateQuote(InsuranceService person)
        {
            var quote = person.CalculateQuote(person.Age,person.Location);  //if using parameters use person.Age,person.Location
            ViewBag.Quote = quote;
